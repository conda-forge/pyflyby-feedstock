...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyflyby-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10198&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyflyby-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyflyby` can be installed with:

```
conda install pyflyby
```

It is possible to list all of the versions of `pyflyby` available on your platform with:
